    ...
    return (
        <>
            <section className="mx-auto flex max-w-6xl flex-col items-center px-6 pb-24 pt-24 text-center sm:pt-32">
                <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-border animate-pulse px-3 py-1.5 text-xs font-medium text-muted-foreground">
                    <span className="h-1.5 w-1.5 rounded-full bg-green-500" />
                    Análise inteligente de código com IA
                </div>

                <h1 className="hero-title-gradient max-w-4xl text-4xl font-bold tracking-tight sm:text-6xl">
                ...
                <p className="mt-6 max-w-2xl text-base leading-7 hero-paragraph sm:text-lg">
