...
export function Header() {
    ...
    return (
        <header className="fixed inset-x-0 top-0 z-50 border-b border-[var(--section-border)] bg-background/80 backdrop-blur-md">
            <div className="mx-auto max-w-6xl px-6">
                ...
                {/* Mobile menu */}
                {menuOpen && (
                    <nav className="border-t border-border py-4 sm:hidden">
